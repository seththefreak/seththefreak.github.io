/*
 * Responsibility: extend ERA source data with weapon style compendium and advanced systems.
 * Exports: augments window.ERA_DATA with STYLE_AFFINITY, STYLE_REACTION_RULES,
 * WEAPON_STYLE_MAP, STYLE_DETAILS and ADVANCED_SYSTEMS.
 */
  ...
  ADVANCED_SYSTEMS: {
    ...
    chaining: {
      ...
      turns: [
        ...
        { turns: "5t", pe: "KW × 4", master: "4d8", mastery: "5d6+", extra: "Escala de cataclismo", req: "Maestria + Nív. 9" },
      ],
      detectability: [
    ...
    projects: {
      tiers: [
        ...
        { grade: "Lendário", stages: "10+", dt: "8–9", time: "Semanas+", req: "Maestria + equipe + Nív. 9", result: "Construtos APEX, portais permanentes ou reescrita maior." },
      ],
      quality: [
        ...
        { name: "Obra-Prima", trigger: "3+ críticos ou Maestria." },
    ...
    relics: {
      tiers: [
        ...
        { tier: "Relíquia Maior", pe: "30–50", req: "Maestria + Nív. 7", will: "Possível" },
        { tier: "Transcendente", pe: "50+", req: "Maestria + Nív. 9", will: "Sim" },
      ],
      willNotes: [
