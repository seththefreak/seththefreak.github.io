(() => {
  const styles = `
    ...
    .startup-glyph {
      font: 700 min(12vw, 64px) "Cormorant Garamond", Georgia, serif;
    ...
    .startup-title {
      font: 700 clamp(2rem, 5vw, 3.8rem) "Cormorant Garamond", Georgia, serif;
      letter-spacing: 0.08em;
    }
    .startup-subtitle {
      margin-top: 6px;
      color: rgba(221, 214, 240, 0.74);
      font: 600 clamp(0.84rem, 2vw, 1rem) "Nunito", Arial, sans-serif;
