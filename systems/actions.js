(function (global) {
  ...
  var ACTION_PRESETS = {
    unified: {
      ...
      slots: [
        { id: 'major', code: 'M', label: 'Maior', desc: 'Golpes pesados, tecnicas amplas e interacoes complexas.', consumes: ['major'], color: '#f97316' },
        { id: 'utility', code: 'u', label: 'Utilidade', desc: 'Itens, saques, suporte rapido e manobras simples.', consumes: ['utility'], color: '#facc15' },
        { id: 'movement', code: 'mov', label: 'Movimento', desc: 'Deslocamento, reposicionamento e cobertura.', consumes: ['movement'], color: '#38bdf8' },
        { id: 'complete', code: 'C', label: 'Completa', desc: 'Consome M + u + mov no mesmo turno.', consumes: ['major', 'utility', 'movement'], color: '#ef4444', derived: true },
